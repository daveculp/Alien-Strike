'''Paralax scrolling starfield.

parameter list:
width -- width of field in pixels
height -- height of field in pixels
x_range -- (min, max) x positions to plot stars in
y_range -- (min, max) y positions to plot starts is
scroll_dir -- initial direction to scroll the fields
	SCROLL_TOP_BOTTOM = 1
	SCROLL_LEFT_RIGHT = 2
	SCROLL_BOTTOM_TOP = 3
	SCROLL_RIGHT_LEFT = 4
colored -- True = colored star field, False = B&W field
star_field_list -- a list of lists in the following form
